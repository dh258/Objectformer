...
def convert_training_to_pretrained(checkpoint_path, output_path, include_performance_metrics=False):
    """
    ...
    metadata['conversion_info']['original_checkpoint'] = os.path.basename(checkpoint_path)
...
def main():
    parser = argparse.ArgumentParser(description='Convert ObjectFormer training checkpoint to pretrained format')
